...
echo -e "${seta} ${ciano}Digite${fim} ${vermelho}[ 1 ]${fim} ${azul}para instalar o driver virt-manager${fim}"
echo -e "${seta} ${ciano}Digite${fim} ${vermelho}[ 2 ]${fim} ${azul}para instalar o driver nvidia${fim}"
...
sleep 2s
echo $pass_user | sudo -S pacman -S ttf-jetbrains-mono ttf-dejavu ttf-hack ttf-nerd-fonts-symbols gnu-free-fonts --noconfirm
clear

# Desinstalando pacotes -------------------------------------------------
echo -e "${seta} ${vermelho}Desinstalando pacotes desnecessários${fim}"
sleep 2s
echo $pass_user | sudo -S pacman -R epiphany malcontent gnome-maps gnome-boxes gnome-contacts gnome-music gnome-software gnome-terminal --noconfirm
clear
...
# Firmwares -------------------------------------------------------------
echo -e "${seta} ${ciano}Instalando os${fim} ${amarelo}firmwares warnigs${fim} ${azul}do archlinux${fim}"
sleep 2s
...
# minecraft-launcher ----------------------------------------------------
echo -e "${seta} ${ciano}Instalando o minecraft-launcher${fim}"
sleep 2s
